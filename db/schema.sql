...
-- Tabela: relatorios_analise_tecnica
...
CREATE INDEX IF NOT EXISTS idx_rat_empreendimento
  ON public.relatorios_analise_tecnica (id_empreendimento);
CREATE INDEX IF NOT EXISTS idx_rat_unidade
  ON public.relatorios_analise_tecnica (id_unidade);
CREATE INDEX IF NOT EXISTS idx_rat_data_emissao
  ON public.relatorios_analise_tecnica (data_emissao);
