...
const DadosPage = ({ relatorio, empreendimento, unidade }) => (
  <div className="px-4 py-2">
    ...
    <div className="p-4 text-sm border rounded-md space-y-4">
      ...
      <div>
        ...
        <span>{relatorio?.endereco_capa || empreendimento?.endereco_empreendimento || '-'}</span>
      </div>
      ...
      {relatorio?.texto_os_proposta && <div><p className="font-semibold text-gray-700">OS / Proposta:</p><span>{relatorio.texto_os_proposta}</span></div>}
    </div>
  </div>
);
