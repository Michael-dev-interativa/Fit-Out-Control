...
const ReportContent = ({ relatorio, empreendimento, navigate }) => {
    ...
    const totalPages = 1 + (combineEquipamentosWithDoc ? 1 : 0) + (hasEquipamentos && !combineEquipamentosWithDoc ? 1 : 0) + (hasDocumentacao && !combineDocWithContent && !combineEquipamentosWithDoc ? 1 : 0) + contentPages.length + 2 + (hasAssinaturas ? 1 : 0);
    let currentPage = 1;
