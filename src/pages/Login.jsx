...
export default function Login({ theme = 'light' }) {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="absolute inset-y-0 left-0 z-10 hidden lg:flex flex-col justify-center pl-[6vw] xl:pl-[8vw] max-w-[48%]">
        <p className="text-white/80 text-xs font-bold tracking-[0.22em] uppercase mb-1">Gerencie sua obra</p>
        ...
        {/* Três diferenciais em linha */}
        <div className="flex items-start gap-6">
          <div className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="w-5 h-5 text-white/80 shrink-0">
              <circle cx="12" cy="12" r="9" /><path d="M12 7v5l3 3" />
            </svg>
            <span className="text-white/80 text-[10px] font-bold tracking-widest uppercase leading-tight">Informações<br />em Tempo Real</span>
          </div>
          <div className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="w-5 h-5 text-white/80 shrink-0">
              <path d="M12 2l7 4v6c0 4.4-3 8.4-7 9.9C8 20.4 5 16.4 5 12V6l7-4z" />
            </svg>
            <span className="text-white/80 text-[10px] font-bold tracking-widest uppercase leading-tight">Segurança<br />de Dados</span>
          </div>
          <div className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="w-5 h-5 text-white/80 shrink-0">
            ...
            <span className="text-white/80 text-[10px] font-bold tracking-widest uppercase leading-tight">Gestão<br />Inteligente</span>
          </div>
        </div>
      </div>
