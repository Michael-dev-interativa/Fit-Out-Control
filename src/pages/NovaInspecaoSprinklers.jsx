...
const t = {
    title: "Nova Inspeção de Sprinklers",
    ...
    physicalInspection: "Inspeção Física - Sprinklers",
...
const defaultInspecaoItems = [
    "Redes e ramais percorrem trajetos de projeto; tubos, conexões, diâmetros e suportação conforme especificações de projeto; pintura cobre e protege todos os trajetos.",
    "Chave de fluxo ref. à área está instalada e conectada ao SDAI.",
    "Status do Comando Setorial (CS) ref. à área está conectado ao SDAI.",
    "Sprinklers (aspersores) pendentes conforme especificado em projeto, posicionamento conforme projeto.",
    "Sprinklers (aspersores) up-right conforme especificado em projeto, posicionamento conforme projeto.",
    "Instalações estão compatibilizadas com outros sistemas, sprinklers estão livres de interferências."
];

export default function NovaInspecaoSprinklers() {
    ...
    const [formData, setFormData] = useState({
        ...
        titulo_relatorio: 'Checklist de Inspeção Física de Sprinklers',
        subtitulo_relatorio: '',
        cliente: '',
        revisao: '01',
        eng_responsavel: '',
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await InspecaoSprinklers.create(dataToSave);
            toast.success("Inspeção criada com sucesso!");
            navigate(createPageUrl(`EmpreendimentoInspecaoSprinklers?empreendimentoId=${empreendimentoId}`));
        } catch (error) {
                    ...
                    <DialogContent className="max-w-md">
                        ...
                        {signatureMode === 'draw' ? (
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                <p className="text-xs text-gray-500">Será exibida em estilo cursivo</p>
                            </div>
                        )}
