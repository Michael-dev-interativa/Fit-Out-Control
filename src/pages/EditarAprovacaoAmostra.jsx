...
const t = {
    title: "Editar Aprovação de Amostra",
...
export default function EditarAprovacaoAmostra() {
    ...
    useEffect(() => {
        ...
        const loadData = async () => {
            try {
                const data = await AprovacaoAmostra.get(relatorioId);
                setFormData({
                    ...data,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await AprovacaoAmostra.update(id, updateData);
            toast.success("Registro atualizado com sucesso!");
            navigate(createPageUrl(`EmpreendimentoAmostras?empreendimentoId=${formData.id_empreendimento}`));
        } catch (error) {
        ...
        <div className="p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mt-2">
                            {formData.fotos.map((foto, idx) => (
                                <div key={idx} className="relative">
                                    ...
                                    <Button type="button" variant="destructive" size="icon" className="absolute top-1 right-1 h-6 w-6" onClick={() => removePhoto(idx)}><Trash2 className="w-3 h-3" /></Button>
                                </div>
                            ))}
                        </div>
                    </CardContent>
                ...
                <Card>
                 ...
                 <Card>
                    <CardHeader><CardTitle>{t.aprovacoes}</CardTitle></CardHeader>
