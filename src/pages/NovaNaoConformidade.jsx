...
import { NaoConformidade, Empreendimento } from '@/api/entities';
...
export default function NovaNaoConformidade() {
    ...
    const [formData, setFormData] = useState({
        ...
        eng_obra: '',
        revisao: '00',
        secoes: [{ nome_secao: '', itens: [{ local: '', complemento: '', disciplina: '', anomalia: '', plano_melhoria: '', cronograma_atividade: 'Pendente', data_status: '', responsavel: '', prazo: '', fotos: [] }] }],
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await NaoConformidade.create(dataToSubmit);
            toast.success("Não conformidade criada com sucesso!");
            navigate(createPageUrl(`EmpreendimentoNaoConformidades?empreendimentoId=${empreendimentoId}`));
        } catch (error) {
