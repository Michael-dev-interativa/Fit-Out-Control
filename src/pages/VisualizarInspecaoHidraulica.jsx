...
const FotoInspecao = ({ url, legenda, maxHeight = '66mm' }) => {
  ...
  return (
    <div className="text-center foto-inspecao bg-white rounded p-2 flex flex-col items-center justify-center" style={{ margin: '4px', maxWidth: '100%', maxHeight, border: 'none', padding: '8px' }}>
