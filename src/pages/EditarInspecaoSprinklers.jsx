...
const t = {
    title: "Editar Inspeção de Sprinklers",
...
export default function EditarInspecaoSprinklers() {
    ...
    useEffect(() => {
        ...
        const loadData = async () => {
            try {
                const data = await InspecaoSprinklers.get(inspecaoId);
                let dataInspecao = '';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await InspecaoSprinklers.update(id, updateData);
            toast.success("Inspeção atualizada com sucesso!");
            navigate(createPageUrl(`EmpreendimentoInspecaoSprinklers?empreendimentoId=${formData.id_empreendimento}`));
        } catch (error) {
